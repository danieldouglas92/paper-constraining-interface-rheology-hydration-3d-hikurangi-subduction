...
namespace aspect
{
  ...
  declare_parameters (ParameterHandler &prm)
  {
    ...
    const std::string allowed_solver_schemes = "single Advection, single Stokes|iterated Advection and Stokes|"
                                               ...
                                               "single Advection, no Stokes|single Advection, no Stokes v2|IMPES|iterated IMPES|"
                    ...
                    const MPI_Comm mpi_communicator)
  {
...

    {
      ...
      else if (solver_scheme == "single Advection, no Stokes v2" || solver_scheme == "Advection only")
        nonlinear_solver = NonlinearSolver::single_Advection_no_Stokes_v2;
